Hooks.once("init", async function() {
  ...
  // Load JSON schema
  const harmCommonSchema = await fetch("modules/fitd-ttk-harm/schemas/harm-common.json").then(r => r.json());
  const harmCardSchema = await fetch("modules/fitd-ttk-harm/schemas/harm-card.json").then(r => r.json());
  const harmConditionsSchema = await fetch("modules/fitd-ttk-harm/schemas/harm-conditions.json").then(r => r.json());
